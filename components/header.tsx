  ...
  return (
    <header>
      ...
      <div className="fixed top-0 left-0 z-10 w-full mix-blend-difference backdrop-blur-md">
        <div className="max-w-350 mx-auto pl-4 lg:pl-0 h-20 flex items-center justify-between">
      ...
      <div className="fixed top-0 left-0 z-10 w-full">
        <div className="max-w-350 mx-auto pr-4 lg:pr-0 h-20 flex items-center justify-end">
